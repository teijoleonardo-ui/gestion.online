      ...
      <section className="flex items-center justify-center px-6 py-12 sm:px-10">
        <div className="w-full max-w-[460px] rounded-[28px] border border-white/[0.07] bg-[oklch(0.13_0_0)] p-8 text-center shadow-[0_40px_100px_-30px_rgba(0,0,0,0.8),0_0_0_1px_rgba(255,255,255,0.02)_inset] sm:p-10">
          ...
          <Button
            ...
            size="lg"
            onClick={() => router.push("/")}
            className="mt-8 h-12 w-full rounded-full text-[0.9375rem] font-semibold tracking-wide text-white transition active:scale-[0.99] bg-[linear-gradient(180deg,#34d399_0%,#059669_100%)] shadow-[0_0_40px_rgba(52,211,153,0.55),0_0_80px_rgba(52,211,153,0.25)] hover:brightness-110"
          >
            Ir al inicio
